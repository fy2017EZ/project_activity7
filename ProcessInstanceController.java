...
//            List<ProcessDefinition> list = repositoryService.createProcessDefinitionQuery().list();
            ...
            if(principal instanceof UserInfoBean){
                UserInfoBean principal2 = (UserInfoBean) principal;
                String[] split = principal2.getRoles().split(",");
                for (Object obj:split) {
                    if(obj.equals("M_ADMIN")){
                        flag = 1;
                        break;
                    }
                }
            }
//            UserInfoBean userInfoBean2 = userMapper.selectByUsername(userName);
//            String[] split = principal.getRoles().split(",");
//            for (Object obj:split) {
//                if(obj.equals("M_ADMIN")){
//                    flag = 1;
//                    break;
